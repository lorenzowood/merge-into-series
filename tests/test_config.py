...
def test_properly_quoted_csv_entry_parses_correctly(tmp_path):
    """Both name and path are quoted — csv.reader gives exactly 3 fields."""
    conf = tmp_path / "test.conf"
    # This is the format csv.writer produces when a field contains a comma.
    conf.write_text(
        'ROOT: /Media/TV\n'
